...
type UserServiceClient interface {
	...
	ListUsers(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (UserService_ListUsersClient, error)
}
...
func (c *userServiceClient) ListUsers(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (UserService_ListUsersClient, error) {
...
type UserServiceServer interface {
	...
	ListUsers(*UserRequest, UserService_ListUsersServer) error
...
func (UnimplementedUserServiceServer) ListUsers(*UserRequest, UserService_ListUsersServer) error {
